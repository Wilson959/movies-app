    ...
    return (
        <div className="grid items-center justify-center h-screen">
            <div className="flex flex-col font-bold text-center items-center h-max">
                ...
                <a href="/" className='bg-blue-500 py-3 px-5 rounded-md mt-5 hover:bg-blue-700 transition-all duration-300 hover:shadow-[0_15px_100px_15px_rgba(59,130,249,0.3)]'>Back to home</a>
            </div>
        </div>
    )
}